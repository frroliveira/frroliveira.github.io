...
é o fornecedor deste website e aplicacões móveis que indiquem esta página. Este documento informa o porquê e como recolhemos, guardamos, usamos e partilhamos a sua informação pessoal, se usar os nossos serviços. A aceitação desta política é obrigatória para poder utilizar as nossas aplicações móveis.
...
Propósito | We aim to provide you with a consistent and comfortable experience when using our applications
Base Legal | You have given us consent
Armazenamento | Data will be kept until the application is uninstalled or data is cleared through the device settings menu

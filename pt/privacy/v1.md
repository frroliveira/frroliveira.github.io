...
Para efeitos do Regulamento Geral sobre a Proteção de Dados (RGPD) o nosso encarregado de proteção de dados é:
...
Informação | Esta política de privacidade contem toda a informação sobre como processamos dados.
Acesso aos Dados | Pode obter uma cópia dos dados que possuímos sobre si.
Retificação de Dados | Pode pedir que a sua informação pessoal seja corrijida.
